## SwiftCart — E-Commerce Product Explorer

## Live link: https://swiftcarts-ecommerce.netlify.app/

## 🚀 Features

### 🧭 Navbar

- Website logo/name **SwiftCart**
...
- Displays selected/top-rated products
- Clean responsive card layout

### 📩 Newsletter & Footer

- Email subscription form
- Footer with social & quick links
...
- Loads categories dynamically from API
- Clickable filter buttons

### Category Filtering

- Clicking a category loads related products
- Grid layout display
